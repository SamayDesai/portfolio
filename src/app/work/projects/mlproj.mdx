---
title: "Using ML for Stock and Commodity Price Prediction"
summary: "An analysis and machine learning application of various supervised and unsupervised models for the clustering and classification of gold commodity prices. *Project Link Requires GT Enterprise Github"
images:
  - "/images/projects/project-01/ml1.png"
  - "/images/projects/project-01/ml2.png"
  - "/images/projects/project-01/ml3.png"
team:
  - name: "Samay Desai"
    role: "Software Engineer"
    avatar: "/images/avatar.jpg"
    linkedIn: "https://www.linkedin.com/in/samaydesai-gt"
link: "https://github.gatech.edu/pages/sdesai328/Group17MLProject/"
---
# Machine Learning for Commodity Price Prediction
* Please look at the project link for the full experience (you will need an enterprise Github account). This project was developed in collaboration with 4 peers.
...
![Alt text](/images/projects/project-01/model1.png)
![Alt text](/images/projects/project-01/model2.png)
![Alt text](/images/projects/project-01/model3.png)

#### Ridge Regression Model Evaluation + Discussion
Though on first glance, the model may seem overfitted, as the predicted gold close line matches the true gold close to a striking degree, we believe that our model is not overfitted. Models that suffer from severe overfitting exhibit a very high Training R² and a much lower Testing R². This is becasue overfitted models generalize poorly to unseen data, resulting in a low R-squared on the test data. However, our model doesn't suffer from this same plight. With a Testing R² of 0.9998 and a Testing R² of 0.9983, the model performs very strongly on both the training set and testing set, showing that it generalizes nicely. Additionally, we can say the same about the Mean Squared Error Values. Both the training and testing set exhibit similar MSE values (~52), showing that we indeed are not overfitting. Thus, based on the strong metrics, we can be pretty confident in our model and its ability to predict gold prices.

## KMeans 

#### Determining Number of Groups
![Alt text](/images/projects/project-01/kmeans1.png)
...
#### KMeans Model
![Alt text](/images/projects/project-01/ml1.png)
![Alt text](/images/projects/project-01/kmeans3.png)
...
![Alt text](/images/projects/project-01/neurnet1.png)
![Alt text](/images/projects/project-01/resplot.png)
...
Based on our training and testing metrics, we can see that our training and test MSE are in a decent range, where our testing error is actually lower. Our R² values indicate that the model explains the vast majority of the variance in the data it is fed. Overall, our metrics show strong generalization and high accuracy, though there is still some room for improvement at extreme price points.

## Random Forest

#### Model + Quantitative Metrics
![Alt text](/images/projects/project-01/randforest1.png)
![Alt text](/images/projects/project-01/randforest2.png)
